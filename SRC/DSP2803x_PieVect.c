...
// Group 10 PIE Vectors
      rsvd_ISR10,        // 10.1 If this is ADCINT1_ISR, then INT1.1 should be defined as rsvd_ISR
      rsvd_ISR10,        // 10.2 If this is ADCINT2_ISR, then INT1.2 should be defined as rsvd_ISR
...
// InitPieVectTable:
//---------------------------------------------------------------------------
// This function initializes the PIE (peripheral interrupt expansion) vector table to a known state.
