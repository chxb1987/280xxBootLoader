...
__interrupt void rsvd_ISR2(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
...
__interrupt void rsvd_ISR4(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
__interrupt void rsvd_ISR5(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
__interrupt void rsvd_ISR6(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
__interrupt void rsvd_ISR7(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
__interrupt void rsvd_ISR8(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
__interrupt void rsvd_ISR9(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
__interrupt void rsvd_ISR10(void)      // ADC INT reserved For test
{
  __asm ("      ESTOP0");
  //for(;;);
}
__interrupt void rsvd_ISR11(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
__interrupt void rsvd_ISR12(void)      // For test
{
  __asm ("      ESTOP0");
  for(;;);
}
